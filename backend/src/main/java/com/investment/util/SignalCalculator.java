...
public final class SignalCalculator {
     ...
     * Signal = s_c * M_info * M_conf * P_subj * P_vol * (0.5 + Q_text)
     */
    public static SignalResult compute(int recommendationScore, double confidence,
        ...
        // Information structure multiplier (from thesis coefficients)
        ...
        double qualityScore = clamp(
                confidence * objectiveRatio * (1.0 - 0.5 * Math.max(0, subjectiveRatio - objectiveRatio)),
                0, 1);
